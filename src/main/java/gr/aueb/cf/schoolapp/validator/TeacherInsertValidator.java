...
public class TeacherInsertValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (teacherInsertDTO.vat() != null && teacherService.isTeacherExistsByVat(teacherInsertDTO.vat())) {
            log.info("Validation failed. Teacher with VAT= {} arleady exists ", teacherInsertDTO.vat());
